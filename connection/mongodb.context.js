...
class MongoDbContext {
  constructor(mongodbConnectionConfig){
    ...
    const url = `mongodb://${mongodbConnectionConfig.username}:${mongodbConnectionConfig.password}@${mongodbConnectionConfig.host}:${mongodbConnectionConfig.port}`;
    ...
    // init models
    this.articleModel = mongoose.model('article', mongoose.Schema(articleSchema));
  }
}
